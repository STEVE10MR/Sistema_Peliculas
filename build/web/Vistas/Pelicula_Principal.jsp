		...
		<div class="contenedor-configuracion">
			<a href="Controlador_I?accion=principal" class="configuracion-en">Configuracion Idioma</a>
                ...
                <div class="configuracion-mostrar-administracion">
                    <a class="btn-crud" href="Controlador_P?accion=registrar"><i class="fas fa-plus"></i></a> 
                    <br>
		    <div class="input-contenedor all">
                    ...
                    <table class="table">
                        ...
                        <tr class="content-value">
                            <td class="text-value"><%=EN_pelicula.getImagen()%></td>
                            <td class="text-value"><%=EN_pelicula.getNombre()%></td>
