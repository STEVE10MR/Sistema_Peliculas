<%-- 
    Document   : Director_Buscar
    Created on : Dec 9, 2021, 6:41:01 AM
    Author     : USUARIO
--%>
<%@page import="java.util.Iterator"%>
<%@page import="Modelo_DAO.Director_DAO"%>
		...
		<div class="contenedor-configuracion">
			<a href="Controlador_I?accion=principal" class="configuracion-en">Configuracion Idioma</a>
                ...
                <div class="configuracion-mostrar-administracion">
                    <a class="btn-crud" href="Controlador_D?accion=registrar"><i class="fas fa-plus"></i></a> 
                    <br>
		    <div class="input-contenedor all">
                    ...
                    <table class="table">
                        ...
                        <%
                            ...
                            ArrayList<Director> l_director=_director.Listar();
                            Iterator<Director>iter=l_director.iterator();
                            Director director=null;
                            while(iter.hasNext()){
                                director=iter.next();
                        %>
                        <tr class="content-value">
                            <td class="text-value"><%=director.getElenco().getNombres()%></td>
                            <td class="text-value"><%=director.getElenco().getApellidos()%></td>
                            <td class="text-button"> 
                                <a class="btn-crud" href="Controlador_D?accion=actualizar&id=<%=director.getElenco().getID()%>"><i class="fas fa-wrench"></i></a> 
                            </td>
                        </tr>
                        <%
                            }
