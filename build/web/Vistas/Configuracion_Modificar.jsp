...
<html>
    ...
    <body>
		...
		<a href="Controlador_U?accion=actualizar" class="configuracion-en">Actualizar Perfil</a>
                <br>
		...
		<form action="Controlador_U?accion=Modificar&id=<%=request.getParameter("id")%>" method="post"  style="width: 500px; height: 450px" class="mostrar-form">
