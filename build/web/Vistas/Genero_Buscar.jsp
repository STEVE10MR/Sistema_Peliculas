<%-- 
    Document   : Genero_Buscar
    Created on : Dec 9, 2021, 7:27:46 AM
    Author     : USUARIO
--%>
		...
		<div class="contenedor-configuracion">
			<a href="Controlador_I?accion=principal" class="configuracion-en">Configuracion Idioma</a>
                ...
                <div class="configuracion-mostrar-administracion">
                    <a class="btn-crud" href="Controlador_G?accion=registrar"><i class="fas fa-plus"></i></a> 
                    <br>
		    <div class="input-contenedor all">
                    ...
                    <table class="table">
                        ...
                        <%
                            ...
                            ArrayList<Genero> l_genero=_genero.Listar();
                            Iterator<Genero>iter=l_genero.iterator();
                            Genero genero=null;
                            while(iter.hasNext()){
                                genero=iter.next();
                        %>
                        <tr class="content-value">
                            <td class="text-value"><%=genero.getNombre()%></td>
                            <td class="text-button"> 
                                <a class="btn-crud" href="Controlador_G?accion=actualizar&id=<%=genero.getID()%>"><i class="fas fa-wrench"></i></a> 
                            </td>
                        </tr>
                        <%
                            }
